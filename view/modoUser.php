...
<body>
    ...
    <main>
        <div class="container-fluid containerBg">
                ...
                ?>
                        <div class="col-sm-2 mb-4">
                            <div class="card w-100 shadow rounded-0 cardVolunteer">
                                ...
                                <div class="card-body">
                                    <div class="card-title textFont"><?= $user['user_mail'] ?></div>
                                </div>
                        ...
                        <div class="col-sm-2 mb-4">
                            <div class="card w-100 shadow rounded-0 cardOrga">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item textFont"><?= $user['organization_adress'] ?></li>
                                    <li class="list-group-item textFont"><?= $user['organization_phone'] ?></li>
                                    <li class="list-group-item textFont"><?= $user['organization_mail'] ?></li>
                                    <li class="list-group-item textFont"><?= $user['organization_siren'] ?></li>
                                    <li class="list-group-item textFont"><?= $user['organization_desc'] ?></li>
                                    <li class="list-group-item textFont"><?= $user['activity_name'] ?></li>
                                </ul>
                                <div class="card-body">
                                    <form method="post" action="">
                                        <button type="submit" name="validateSubmit" id="validateSubmit" class="btn btn-light font-weight-bold textFont mr-2" value="<?= $user['id_user'] ?>">
                                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-check-square-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2zm10.03 4.97a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z" />
                                            </svg>
                                        </button>
                                        <button type="submit" name="deleteSubmit" id="deleteSubmit" class="btn btn-light font-weight-bold textFont mr-2" value="<?= $user['id_user'] ?>">
                                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-trash-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                <path fill-rule="evenodd" d="M2.5 1a1 1 0 0 0-1 1v1a1 1 0 0 0 1 1H3v9a2 2 0 0 0 2 2h6a2 2 0 0 0 2-2V4h.5a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H10a1 1 0 0 0-1-1H7a1 1 0 0 0-1 1H2.5zm3 4a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7a.5.5 0 0 1 .5-.5zM8 5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-1 0v-7A.5.5 0 0 1 8 5zm3 .5a.5.5 0 0 0-1 0v7a.5.5 0 0 0 1 0v-7z" />
                                            </svg>
                                        </button>
            ...
            <hr>
            <div class="row">
                <div class="col text-uppercase h4 text-dark text-center">modérateurs</div>
            </div>
            <div class="row">
                <?php
                foreach ($getUserArray as $user) {
                    if ($user['id_usertypes'] == 1 && $user['user_moderator'] == 1) {
                ?>
                        <div class="col-sm-2 mb-4">
                            <div class="card w-100 shadow rounded-0 cardVolunteer">
                                <div class="text-center mt-2">
