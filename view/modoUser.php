                ...
                <div class="col-sm-4 mb-4">
                    <div class="card w-100 shadow rounded bg-dark text-white">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-dark"><?= $user['volunteer_firstname'] ?></li>
                            <li class="list-group-item bg-dark"><?= $user['volunteer_lastname'] ?></li>
            ...
            ?>
                <div class="col-sm-4 mb-4">
                    <div class="card w-100 shadow rounded bg-dark text-white">
                        ...
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item bg-dark"><?= $user['organization_name'] ?></li>
                            <li class="list-group-item bg-dark"><?= $user['organization_adress'] ?></li>
                            <li class="list-group-item bg-dark"><?= $user['organization_phone'] ?></li>
                            <li class="list-group-item bg-dark"><?= $user['organization_mail'] ?></li>
                            <li class="list-group-item bg-dark"><?= $user['organization_siren'] ?></li>
                            <li class="list-group-item bg-dark"><?= $user['organization_desc'] ?></li>
