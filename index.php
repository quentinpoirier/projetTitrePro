...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark mb-3">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="#">Bénévoles</a>
                </li>
                <li class="nav-item">
        ...
        <form class="form-inline">
            <div class="form-group mx-sm-3">
                <button class="btn btn-outline-secondary text-white ml-2" type="button" data-toggle="modal" data-target="#connexionModal">connexion</button>
            </div>
            <div class="form-group">
                <button class="btn btn-outline-secondary text-white" type="button" data-toggle="modal" data-target="#inscriptionModal">inscription</button>
            </div>
        </form>
    </nav>
                ...
                <div class="col-sm-4">
                    <div class="card w-100 shadow rounded">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-dark">site web</a>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
    ...
    <footer class="d-flex flex-row align-items-center justify-content-center bg-dark header mt-3">
        <div class="d-flex">
