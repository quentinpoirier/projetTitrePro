                ...
                <div class="col-sm-6">
                    ...
                    <form class="bg-dark p-4 rounded-lg" action="index.php" method="post" novalidate>
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control " id="advertTitle" name="advertTitle" required>
                        </div>
                        <div class="form-group">
                            <label for="advertObject" class="text-white text-uppercase">Objet</label>
                            <input type="text" class="form-control " id="advertObject" name="advertObject" required>
                        </div>
                        <div class="form-group">
                            <label for="advertDesc" class="text-white text-uppercase">Description</label>
                            <textarea type="text" class="form-control" id="advertDesc" name="advertDesc" rows="3" required></textarea>
                        </div>
                        <div class="form-group">
